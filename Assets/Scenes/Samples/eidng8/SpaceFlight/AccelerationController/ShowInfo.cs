...
namespace Samples.eidng8.SpaceFlight.AccelerationController
{
    public class ShowInfo : MonoBehaviour
    {
        ...
        private void Start()
        {
            EventManager.Mgr.OnUserEvent(UserEvents.Select, OnSelectObject);
            this.obj = GameObject.FindWithTag("Player");
        }
